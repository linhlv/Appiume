...
namespace Appiume.Web.IoT.Core.Events
{
    public class EventRegistrationPolicy : IoTServiceBase, IEventRegistrationPolicy
    {
        ...
        private async Task CheckEventRegistrationFrequencyAsync(User user)
        {
            ...
            var maxAllowedEventRegistrationCountInLast30DaysPerUser = await SettingManager.GetSettingValueAsync<int>(IoTSettingNames.MaxAllowedEventRegistrationCountInLast30DaysPerUser);
