...
namespace Appiume.Web.Modules.TaskCloud.EntityFramework.Repositories
{
    ...
    /// </summary>
    public class TaskRepository : TaskCloudRepositoryBase<Task, long>, ITaskRepository
    {
        public TaskRepository(IDbContextProvider<TaskCloudDbContext> dbContextProvider)
