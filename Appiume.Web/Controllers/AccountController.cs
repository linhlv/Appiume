    ...
    public class AccountController : EventCloudControllerBase
    {
        ...
        public virtual async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                _unitOfWorkManager.Current.EnableFilter(ApmDataFilters.MayHaveTenant);
                _unitOfWorkManager.Current.SetFilterParameter(ApmDataFilters.MayHaveTenant, ApmDataFilters.Parameters.TenantId, tenant.Id);
                ...
                if (user.IsActive)
                {
                    ApmUserManager<Tenant, Role, User>.ApmLoginResult loginResult;
                    if (externalLoginInfo != null)
                    {
                    ...
                    if (loginResult.Result == ApmLoginResultType.Success)
                    {
        ...
        public virtual async Task<ActionResult> RegisterTenant(RegisterTenantViewModel model)
        {
            try
            {
                ...
                using (_unitOfWorkManager.Current.SetFilterParameter(ApmDataFilters.MayHaveTenant, ApmDataFilters.Parameters.TenantId, tenant.Id))
                {
        ...
        public virtual async Task<ActionResult> ExternalLoginCallback(string returnUrl, string tenancyName = "")
        {
            ...
            switch (loginResult.Result)
            {
                ...
                case ApmLoginResultType.UnknownExternalLogin:
        ...
        {
            List<User> allUsers;
            using (_unitOfWorkManager.Current.DisableFilter(ApmDataFilters.MayHaveTenant))
            {
