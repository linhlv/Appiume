...
namespace Appiume.Apm.Configuration
{
    ...
    public static class CacheManagerSettingExtensions
    {
        ...
        {
            return cacheManager
                .GetCache<string, Dictionary<string, SettingInfo>>(ApmCacheNames.ApplicationSettings);
        }
        ...
        {
            return cacheManager
                .GetCache<int, Dictionary<string, SettingInfo>>(ApmCacheNames.TenantSettings);
        }
        ...
        {
            return cacheManager
                .GetCache<string, Dictionary<string, SettingInfo>>(ApmCacheNames.UserSettings);
        }
    }
}