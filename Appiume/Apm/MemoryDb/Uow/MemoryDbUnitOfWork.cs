...
namespace Appiume.Apm.MemoryDb.Uow
{
    ...
    public class MemoryDbUnitOfWork : UnitOfWorkBase, ITransientDependency
    {
        ...
        private readonly IApmMemoryDbModuleConfiguration _configuration;
        private readonly MemoryDatabase _memoryDatabase;

        /// <summary>
        /// Constructor.
        /// </summary>
        public MemoryDbUnitOfWork(IApmMemoryDbModuleConfiguration configuration, MemoryDatabase memoryDatabase, IConnectionStringResolver connectionStringResolver, IUnitOfWorkDefaultOptions defaultOptions)
