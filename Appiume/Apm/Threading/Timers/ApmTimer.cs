...
namespace Appiume.Apm.Threading.Timers
{
    /// <summary>
    ...
    public class ApmTimer : RunnableBase, ITransientDependency
    {
        /// <summary>
        ...
        public ApmTimer(int period, bool runOnStart = false)
            : this()
        {
            Period = period;
        ...
        public override void Start()
        {
            if (Period <= 0)
            {
                throw new ApmException("Period should be set before starting the timer!");
            }
