...
namespace Appiume.Apm.Aspects
{
    internal static class ApmCrossCuttingConcerns
    {
        public const string Auditing = "ApmAuditing";
        public const string Validation = "ApmValidation";
        public const string UnitOfWork = "ApmUnitOfWork";
        public const string Authorization = "ApmAuthorization";
