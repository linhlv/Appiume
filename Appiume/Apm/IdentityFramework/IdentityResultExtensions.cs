...
using Appiume.Apm.Text;
using Appiume.Apm.UI;
using Microsoft.AspNet.Identity;

namespace Appiume.Apm.IdentityFramework
{
    public static class IdentityResultExtensions
    {
        ...
        public static string LocalizeErrors(this IdentityResult identityResult, ILocalizationManager localizationManager)
        {
            ...
            if (identityResult is ApmIdentityResult)
            {
        ...
        {
            var localizationSource = localizationManager.GetSource(ApmTenancyConsts.LocalizationSourceName);
