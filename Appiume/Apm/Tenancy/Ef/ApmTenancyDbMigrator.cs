...
using Appiume.Apm.Tenancy.Data;
using Appiume.Apm.Tenancy.MultiTenancy;

namespace Appiume.Apm.Tenancy.Ef
{
    public abstract class ApmTenancyDbMigrator<TDbContext, TConfiguration> : IApmTenancyDbMigrator, ITransientDependency
        ...
        where TConfiguration : DbMigrationsConfiguration<TDbContext>, IMultiTenantSeed, new()
    {
        ...
        protected ApmTenancyDbMigrator(
        ...
        public virtual void CreateOrMigrateForTenant(ApmTenantBase tenant)
        {
        ...
        protected virtual void CreateOrMigrate(ApmTenantBase tenant)
        {
