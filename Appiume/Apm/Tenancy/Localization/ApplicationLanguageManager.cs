...
namespace Appiume.Apm.Tenancy.Localization
{
        ...
        ISingletonDependency
    {
        ...
        /// </summary>
        public const string CacheName = "ApmTenancyLanguages";
        ...
        public virtual async Task AddAsync(ApplicationLanguage language)
        {
            ...
            {
                throw new ApmException("There is already a language with name = " + language.Name); //TODO: LOCALIZE?
            }
        ...
        public virtual async Task RemoveAsync(int? tenantId, string languageName)
        {
            ...
            {
                throw new ApmException("Can not delete a host language from tenant!"); //TODO: LOCALIZE?
            }
        ...
        public virtual async Task UpdateAsync(int? tenantId, ApplicationLanguage language)
        {
            ...
            {
                throw new ApmException("Can not update a host language from tenant"); //TODO: LOCALIZE
            }
        ...
        public void HandleEvent(EntityChangedEventData<ApplicationLanguage> eventData)
        {
            ...
            _cacheManager.GetCache("ApmLocalizationScripts").Clear(); //TODO: CAN BE AN OPTIMIZATION?
        }
