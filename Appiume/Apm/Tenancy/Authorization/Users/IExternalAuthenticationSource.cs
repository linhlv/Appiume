...
{
    /// <summary>
    /// Defines an authorization source to be used by <see cref="ApmUserManager{TTenant,TRole,TUser}.LoginAsync"/> method.
    /// </summary>
        ...
        where TUser : ApmUser<TUser>
    {
        ...
        /// This source name is set to <see cref="ApmUser{TTenant,TUser}.AuthenticationSource"/>
