...
namespace Appiume.Apm.Tenancy.Application.Features
{
    ...
    /// </summary>
    public abstract class ApmFeatureValueStore<TTenant, TRole, TUser> : IApmTenancyFeatureValueStore, ITransientDependency
        ...
        where TUser : ApmUser<TUser>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApmFeatureValueStore{TTenant, TRole, TUser}"/> class.
        /// </summary>
        protected ApmFeatureValueStore(
