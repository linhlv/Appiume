...
namespace Appiume.Apm.Web.WebApi.Controllers.Dynamic.Interceptors
{
    /// <summary>
    ...
    public class ApmDynamicApiControllerInterceptor<T> : IInterceptor
    {
        /// <summary>
