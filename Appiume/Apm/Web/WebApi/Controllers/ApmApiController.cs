...
{
    /// <summary>
    /// Base class for all ApiControllers in web applications those use Apm system.
    /// </summary>
    public abstract class ApmApiController : ApiController
    {
        /// <summary>
        ...
        /// Gets current session information.
        /// </summary>
        [Obsolete("Use ApmSession property instead. CurrentSetting will be removed in future releases.")]
