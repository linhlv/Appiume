...
using Appiume.Apm.Web.WebApi.ProxyScripting.Generators;
...
namespace Appiume.Apm.Web.WebApi.ProxyScripting
{
    public class ApiProxyScriptManager : IApiProxyScriptManager, ISingletonDependency
    {
        ...
        private string CreateScript(ApiProxyGenerationOptions options)
        {
            ...
            {
                throw new ApmException($"Could not find a proxy script generator with given name: {options.GeneratorType}");
            }
