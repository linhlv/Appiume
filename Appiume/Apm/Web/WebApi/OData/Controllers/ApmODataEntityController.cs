...
namespace Appiume.Apm.Web.WebApi.OData.Controllers
{
    public abstract class ApmODataEntityController<TEntity> : ApmODataEntityController<TEntity, int>
        where TEntity : class, IEntity<int>
    {
        protected ApmODataEntityController(IRepository<TEntity> repository)
            : base(repository)
        {
    ...
    public abstract class ApmODataEntityController<TEntity, TPrimaryKey> : ODataController
        ...
        where TEntity : class, IEntity<TPrimaryKey>
    {
        ...
        protected ApmODataEntityController(IRepository<TEntity, TPrimaryKey> repository)
        {
