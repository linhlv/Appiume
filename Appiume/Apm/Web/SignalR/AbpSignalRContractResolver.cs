...
namespace Appiume.Apm.Web.SignalR
{
    ...
    /// </summary>
    public class ApmSignalRContractResolver : IContractResolver
    {
        /// <summary>
        ...
        static ApmSignalRContractResolver()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApmSignalRContractResolver"/> class.
        /// </summary>
        public ApmSignalRContractResolver()
        {
