...
namespace Appiume.Apm.Web.Mvc.Views
{
    /// <summary>
    /// Base class for all views in Apm system.
    /// </summary>
    /// <typeparam name="TModel">Type of the View Model</typeparam>
    public abstract class ApmWebViewPage<TModel> : WebViewPage<TModel>
    {
        /// <summary>
