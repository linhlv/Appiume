...
namespace Appiume.Apm.Web.WebApi.Authorization
{
    ...
    /// </summary>
    public class ApmApiAuthorizeAttribute : AuthorizeAttribute, IApmAuthorizeAttribute
    {
        /// <inheritdoc/>
        ...
        /// <summary>
        /// Creates a new instance of <see cref="ApmApiAuthorizeAttribute"/> class.
        /// </summary>
        /// <param name="permissions">A list of permissions to authorize</param>
        public ApmApiAuthorizeAttribute(params string[] permissions)
        {
