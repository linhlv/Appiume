...
using Appiume.Apm.Web.WebApi.Controllers.Dynamic.Interceptors;
...
namespace Appiume.Apm.Web.WebApi.Controllers.Dynamic.Builders
{
    ...
    internal class ApiControllerBuilder<T> : IApiControllerBuilder<T>
    {
        ...
        public IApiControllerActionBuilder<T> ForMethod(string methodName)
        {
            ...
            {
                throw new ApmException("There is no method with name " + methodName + " in type " + typeof(T).Name);
            }
        ...
        public void Build()
        {
            var controllerInfo = new DynamicApiControllerInfo(
                ...
                typeof(ApmDynamicApiControllerInterceptor<T>),
                Filters
                );
