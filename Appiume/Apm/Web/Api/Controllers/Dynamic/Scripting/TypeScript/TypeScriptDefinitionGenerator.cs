    ...
    public class TypeScriptDefinitionGenerator : ITransientDependency
    {
        public string GetScript()
        {
            ...
            if (servicePrefix.IsNullOrEmpty())
                script.AppendLine("declare module apm.services");//Create a new Module
            else
                script.AppendLine("declare module apm.services." + servicePrefix);//Create a new Module
            script.AppendLine("{");
            ...
            script.AppendLine("}");
            #region Create Script for Apm common objects

            script.AppendLine("declare module apm {");
