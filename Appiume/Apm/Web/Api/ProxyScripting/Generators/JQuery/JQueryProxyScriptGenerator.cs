...
namespace Appiume.Apm.Web.WebApi.ProxyScripting.Generators.JQuery
{
    public class JQueryProxyScriptGenerator : IProxyScriptGenerator, ITransientDependency
    {
        ...
        public string CreateScript(ApplicationApiDescriptionModel model)
        {
            ...
            script.AppendLine("/* This file is automatically generated by Apm framework to use MVC Controllers from javascript. */");
            script.AppendLine();
            script.AppendLine("var apm = apm || {};");
            script.AppendLine("apm.services = apm.services || {};");
        ...
        private static void AddModuleScript(StringBuilder script, ModuleApiDescriptionModel module)
        {
            ...
            script.AppendLine();
            script.AppendLine($"  apm.services.{module.Name.ToCamelCase()} = apm.services.{module.Name.ToCamelCase()} || {{}};");
        ...
        private static void AddControllerScript(StringBuilder script, ModuleApiDescriptionModel module, ControllerApiDescriptionModel controller)
        {
            ...
            script.AppendLine($"    apm.services.{module.Name.ToCamelCase()}.{controller.Name.ToCamelCase()} = apm.services.{module.Name.ToCamelCase()}.{controller.Name.ToCamelCase()} || {{}};");
        ...
        private static void AddActionScript(StringBuilder script, ModuleApiDescriptionModel module, ControllerApiDescriptionModel controller, ActionApiDescriptionModel action)
        {
            ...
            script.AppendLine($"    apm.services.{module.Name.ToCamelCase()}.{controller.Name.ToCamelCase()}.{action.Name.ToCamelCase()} = function({parameterList}) {{");
            script.AppendLine("      return apm.ajax($.extend(true, {");
        ...
        private static void AddAjaxCallParameters(StringBuilder script, ControllerApiDescriptionModel controller, ActionApiDescriptionModel action)
        {
            ...
            script.AppendLine("        url: apm.appPath + '" + ProxyScriptingHelper.GenerateUrlWithParameters(action) + "',");
