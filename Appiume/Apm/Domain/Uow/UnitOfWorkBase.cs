...
namespace Appiume.Apm.Domain.Uow
{
    ...
    public abstract class UnitOfWorkBase : IUnitOfWork
    {
        ...
        /// <summary>
        /// Reference to current Apm session.
        /// </summary>
        public IApmSession ApmSession { private get; set; }
        ...
        public void Begin(UnitOfWorkOptions options)
        {
            ...
            SetTenantId(ApmSession.TenantId);
        ...
        public IDisposable SetTenantId(int? tenantId)
        {
            ...
            var mustHaveTenantEnableChange = tenantId == null
                ? DisableFilter(ApmDataFilters.MustHaveTenant)
                : EnableFilter(ApmDataFilters.MustHaveTenant);

            var mayHaveTenantChange = SetFilterParameter(ApmDataFilters.MayHaveTenant, ApmDataFilters.Parameters.TenantId, tenantId);
            var mustHaveTenantChange = SetFilterParameter(ApmDataFilters.MustHaveTenant, ApmDataFilters.Parameters.TenantId, tenantId ?? 0);
        ...
        private void PreventMultipleBegin()
        {
            ...
            {
                throw new ApmException("This unit of work has started before. Can not call Start method more than once.");
            }
        ...
        private void PreventMultipleComplete()
        {
            ...
            {
                throw new ApmException("Complete is called before!");
            }
        ...
        private void SetFilters(List<DataFilterConfiguration> filterOverrides)
        {
            ...
            if (ApmSession.TenantId == null)
            {
                ChangeFilterIsEnabledIfNotOverrided(filterOverrides, ApmDataFilters.MustHaveTenant, false);
            }
        }
        ...
        private DataFilterConfiguration GetFilter(string filterName)
        {
            ...
            if (filter == null)
            {
                throw new ApmException("Unknown filter name: " + filterName + ". Be sure this filter is registered before.");
            }
