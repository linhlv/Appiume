...
namespace Appiume.Apm.Domain.Uow
{
    ...
    public interface IActiveUnitOfWork
    {
        ...
        /// </summary>
        /// <param name="filterNames">One or more filter names. <see cref="ApmDataFilters"/> for standard filters.</param>
        ...
        /// </summary>
        /// <param name="filterName">Name of the filter. <see cref="ApmDataFilters"/> for standard filters.</param>
