...
namespace Appiume.Apm.Ef.GraphDiff.Mapping
{
    ...
    {
        private readonly IApmEntityFrameworkGraphDiffModuleConfiguration _moduleConfiguration;

        /// <summary>
        /// Constructor.
        /// </summary>
        public EntityMappingManager(IApmEntityFrameworkGraphDiffModuleConfiguration moduleConfiguration)
        {
