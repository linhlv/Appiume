...
namespace Appiume.Apm.Authorization
{
    ...
    /// </summary>
    public class ApmAuthorizeAttribute : Attribute, IApmAuthorizeAttribute
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new instance of <see cref="ApmAuthorizeAttribute"/> class.
        /// </summary>
        /// <param name="permissions">A list of permissions to authorize</param>
        public ApmAuthorizeAttribute(params string[] permissions)
        {
