...
namespace Appiume.Apm.Notifications
{
    ...
    internal class NotificationDefinitionManager : INotificationDefinitionManager, ISingletonDependency
    {
        ...
        public void Add(NotificationDefinition notificationDefinition)
        {
            ...
            {
                throw new ApmInitializationException("There is already a notification definition with given name: " + notificationDefinition.Name + ". Notification names must be unique!");
            }
        ...
        public NotificationDefinition Get(string name)
        {
            ...
            if (definition == null)
            {
                throw new ApmException("There is no notification definition with given name: " + name);
            }
